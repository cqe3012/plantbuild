                    ...
                    <div class="grid_12">
                        <nav class="horizontal-nav full-width horizontalNav-notprocessed">
                            <ul class="sf-menu">
                                ...
                                <li class="current"><a href="guanye.php">观叶植物</a></li>
                            </ul>
                        </nav>
                        <div class="clear"></div>
                    </div>
            ...
            <div class="container_12">
                ...
                <div class="grid_6">                
                    <div class="img_block fleft">                                         
                        <div class="img_inner">
                            ...
                            $pic = $mydb->select("plant", ["picture"], ["flag" => "1","type" => "观叶植物"]);
                            $a = $pic[0]["picture"];
                            echo "<img src='{$a}'/>";
                            ?>
                        </div>
                    ...
                    <div class="extra_wrapper">
                        <div class="text1"><a href="#"> 
                                <strong><?php
                                    $data = $mydb->select('plant', ['name'], ["flag" => "1","type" => "观叶植物"]);
                                    echo $data[0]["name"];
                                    ?></strong>&nbsp;<?php
                                    $data = $mydb->select('plant', ['englishname'], ["flag" => "1","type" => "观叶植物"]);
                                    echo $data[0]["englishname"];
                                    ?><br></a>
                        </div><br>别名：
                        <?php
                        $data = $mydb->select('plant', ['another_name', 'feature', 'fun', 'culture'], ["flag" => "1","type" => "观叶植物"]);
                ...
                <div class="grid_6">                
                    <div class="img_block fleft">                                         
                        <div class="img_inner">
                            <?php
                            $pic = $mydb->select("plant", ["picture"], ["flag" => "0","type" => "观叶植物"]);
                            $a = $pic[0]["picture"];
                            echo "<img src='{$a}'/>";
                            ?>
                        </div>
                    ...
                    <div class="extra_wrapper">
                        <div class="text1"><a href="#"> 
                                <strong><?php
                                    $data = $mydb->select('plant', ['name'], ["flag" => "0","type" => "观叶植物"]);
                                    echo $data[0]["name"];
                                    ?></strong>&nbsp;<?php
                                    $data = $mydb->select('plant', ['englishname'], ["flag" => "0","type" => "观叶植物"]);
                                    echo $data[0]["englishname"];
                                    ?><br></a>
                        </div><br>别名：
                        <?php
                        $data = $mydb->select('plant', ['another_name', 'feature', 'fun', 'culture'], ["flag" => "0","type" => "观叶植物"]);
                        echo $data[0]["another_name"];
                        echo "<br><br> <b>生态特征：</b>";
                        echo $data[0]["feature"];
                        echo "<br> <b>植物趣事：</b>";
            ...
            <div class="container_12">
                <div class="grid_11">
                    ...
                    <div class="extra_wrapper">
                        <ul class="list l1">
                            <li>
                                <div class="price"><a href="#">一品红</a><span>$ 145.20</span></div>
                            </li>
                            <li>
                                <div class="price"><a href="#">石楠</a><span>$ 130.10</span></div>
                            </li>
                            <li>
                                <div class="price"><a href="#">富贵竹</a><span>$ 163.50</span></div>
                            </li>
                            <li>
                                <div class="price"><a href="#">常春藤</a><span>$ 190.30</span></div>
                            </li>
                            <li>
                                <div class="price"><a href="#">红掌</a><span>$ 145.60</span></div>
                            </li>
                            <li>
                                <div class="price"><a href="#">紫叶李</a><span>$ 10.79 </span></div>
                            </li>	
                        </ul>
                    </div>
                </div>
        ...
        <script>
            $(document).ready(function ()
            {
                ...
                $(".top").click(function () {
                    ...
                    //跳转到置顶页面并传递植物类型和名称
                    window.location.href= "top.php?type=观叶植物&name="+name;
                })
            })                        
        </script>
    </body>
