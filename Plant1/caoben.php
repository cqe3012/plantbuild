                    ...
                    <div class="grid_12">
                        <nav class="horizontal-nav full-width horizontalNav-notprocessed">
                            <ul class="sf-menu">
                                ...
                                <li class="current"><a href="caoben.php">草本植物</a></li>
            ...
            <div class="container_12">
                ...
                <div class="grid_6">
                    <div class="img_block fleft">                                                
                        <div class="img_inner">
                            ...
                            $pic = $mydb->select("plant", ["picture"], ["flag" => "1", "type" => "草本植物"]);
                            $a = $pic[0]["picture"];
                            echo "<img src='{$a}'/>";
                            ?>
                        </div>
                    ...
                    <div class="extra_wrapper">
                        <div class="text1">
                            <a href="#"> 
                                <strong><?php
                                    $data = $mydb->select('plant', ['name'], ["flag" => "1", "type" => "草本植物"]);
                                    echo $data[0]["name"];
                                    ?>
                                </strong>&nbsp;<?php
                                $data = $mydb->select('plant', ['englishname'], ["flag" => "1", "type" => "草本植物"]);
                                echo $data[0]["englishname"];
                                ?><br>
                            </a>
                        </div><br>别名：
                        <?php
                        $data = $mydb->select('plant', ['another_name', 'feature', 'fun', 'culture'], ["flag" => "1", "type" => "草本植物"]);
                ...
                <div class="grid_6">                
                    <div class="img_block fleft">                                         
                        <div class="img_inner">
                            <?php
                            $pic = $mydb->select("plant", ["picture"], ["flag" => "0", "type" => "草本植物"]);
                            $a = $pic[0]["picture"];
                            echo "<img src='{$a}'/>";
                            ?>
                        </div>
                    ...
                    <div class="extra_wrapper">
                        <div class="text1">
                            <a href="#"> 
                                <strong><?php
                                    require 'medooinit.php';
                                    $data = $mydb->select('plant', ['name'], ["flag" => "0", "type" => "草本植物"]);
                                    echo $data[0]["name"];
                                    ?>
                                </strong>&nbsp;<?php
                                $data = $mydb->select('plant', ['englishname'], ["flag" => "0", "type" => "草本植物"]);
                                echo $data[0]["englishname"];
                                ?><br>
                            </a>
                        </div><br>别名：
                        <?php
                        $data = $mydb->select('plant', ['another_name', 'feature', 'fun', 'culture'], ["flag" => "0", "type" => "草本植物"]);
                        echo $data[0]["another_name"];
                        echo "<br><br> <b>生态特征：</b>";
                        echo $data[0]["feature"];
                        echo "<br> <b>植物趣事：</b>";
            ...
            <div class="container_12">
                <div class="grid_11">
                    ...
                    <div class="extra_wrapper">
                        <ul class="list l1">
                            <li>
                                <div class="price"><a href="#">雪莲</a><span>$ 945</span></div>
                            </li>
                            <li>
                                <div class="price"><a href="#">四季豆</a><span>$ 12.10</span></div>
                            </li>
                            <li>
                                <div class="price"><a href="#">薰衣草</a><span>$ 63.50</span></div>
                            </li>
                            <li>
                                <div class="price"><a href="#">勿忘草</a><span>$ 0</span></div>
                            </li>
                            <li>
                                <div class="price"><a href="#">向日葵</a><span>$ 45.60</span></div>
                            </li>
                            <li>
                                <div class="price"><a href="#">吊兰</a><span>$ 50.79 </span></div>
                            </li>	
                        </ul>
                    </div>
                </div>
        ...
        <script>
            $(document).ready(function ()
            {
                ...
                $(".top").click(function () {
                    ...
                    //跳转到置顶页面并传递植物类型和名称
                    window.location.href = "top.php?type=草本植物&name=" + name;
                })
            })
        </script>
    </body>
